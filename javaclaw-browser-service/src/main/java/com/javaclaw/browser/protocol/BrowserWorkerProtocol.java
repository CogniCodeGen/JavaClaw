...
public final class BrowserWorkerProtocol {
    ...
    public record Command(int version, long id, String operation, CanonicalPayload payload, int sensitiveStateBytes) {
        ...
        public Command {
            ...
            if (!Set.of(SNAPSHOT, LOGIN, OAUTH, InteractiveBrowserProtocol.OPEN, BrowserRegistrationProtocol.OPEN)
                    .contains(operation)) {
            ...
            if ((OAUTH.equals(operation) || BrowserRegistrationProtocol.OPEN.equals(operation))
                    && sensitiveStateBytes != 0) {
