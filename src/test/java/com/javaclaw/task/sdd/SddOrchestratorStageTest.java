...
class SddOrchestratorStageTest {
    ...
    void 准备阶段落盘后实现阶段从OpenSpec继续且不重复准备() throws Exception {
        ...
        SddOrchestrator orchestrator = new SddOrchestrator(context, store,
                new ScenarioVerifier(temp.toString(), null, null), agents,
        ...
        String storedTasks = readTasksDocument(temp, context.slug());
    ...
    private static String readTasksDocument(Path workDir, String slug) throws Exception {
