...
/** 分层 Prompt provenance 查询的薄 RPC 映射。 */
public final class PromptPreviewRpcHandlers {
    ...
    public RpcRouter.Builder register(RpcRouter.Builder routes) {
        return Objects.requireNonNull(routes, "routes").register("prompt/manifest/preview", this::preview);
    }

    private CanonicalPayload preview(CanonicalPayload params) {
        PromptManifestRpcContracts.PreviewPayload payload =
                json.decode(params, PromptManifestRpcContracts.PreviewPayload.class);
