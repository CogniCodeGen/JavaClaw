...
class PromptOptimizationRpcContractsTest {
    ...
    void methodCatalogReferencesSchemasForEveryOptimizationMethod() throws IOException {
        ...
        String schema = resource("/schema/prompt-optimization-v3.schema.json");

        List.of(
                        "start\", \"kind\": \"command\", \"paramsSchema\": \"prompt-optimization-v3.schema.json#/$defs/startCommand",
                        "read\", \"kind\": \"query\", \"paramsSchema\": \"prompt-optimization-v3.schema.json#/$defs/readPayload",
                        "list\", \"kind\": \"query\", \"paramsSchema\": \"prompt-optimization-v3.schema.json#/$defs/listPayload",
                        "cancel\", \"kind\": \"command\", \"paramsSchema\": \"prompt-optimization-v3.schema.json#/$defs/cancelCommand",
                        "adopt\", \"kind\": \"command\", \"paramsSchema\": \"prompt-optimization-v3.schema.json#/$defs/adoptCommand")
                .forEach(contract -> assertTrue(methods.contains("agent/role/prompt/optimization/" + contract)));
        ...
        assertTrue(schema.contains("\"agentRole\": {"));
