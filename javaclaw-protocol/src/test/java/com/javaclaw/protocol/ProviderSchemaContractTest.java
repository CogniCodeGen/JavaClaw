...
class ProviderSchemaContractTest {
    ...
    private static JsonNode schema() throws IOException {
        try (var input = ProviderSchemaContractTest.class.getResourceAsStream("/schema/provider-v3.schema.json")) {
            if (input == null) {
                throw new IOException("provider-v3 schema not found");
            }
