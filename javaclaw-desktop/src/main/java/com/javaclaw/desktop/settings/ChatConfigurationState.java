...
record ChatConfigurationState(
        ExecutionOverrides selection, Optional<ExecutionSelectionLoader.Snapshot> snapshot,
        Optional<ExecutionPreview> preview, boolean pending, boolean dirty, String message) {
    boolean ready() {
