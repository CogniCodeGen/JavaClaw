...
/** Prompt provenance 页面访问 Workspace 与 Agent Role SDK 的异步边界。 */
public interface PromptPreviewSettingsGateway {
     ...
     * @param role 精确 Agent Role 引用
     * @return 脱敏来源、完整 manifest 摘要和 token 估算
     */
    CompletionStage<PromptManifestPreview> preview(WorkspaceId workspaceId, AgentRoleRef role);
}
